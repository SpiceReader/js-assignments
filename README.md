...
## Javascript Assignments  [![Build Status](https://travis-ci.org/SpiceReader/js-assignments.svg?branch=master)](https://travis-ci.org/SpiceReader/js-assignments)
...
```
* Open https://github.com/SpiceReader/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
